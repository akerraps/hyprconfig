...
" Disable GitGutter when opening NERDTree
autocmd FileType nerdtree silent! GitGutterEnable

" Re-enable GitGutter when leaving the NERDTree buffer
autocmd BufLeave * if &ft ==# 'nerdtree' | silent! GitGutterDisable | endif
